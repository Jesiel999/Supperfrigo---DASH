...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'pmp',             canActivate: [permissaoGuard('pmp')],             loadComponent: () => import('./pages/sances/financeiro/pmp/pmp').then(m => m.PmpComponent) },
      { path: 'pmr',             canActivate: [permissaoGuard('pmr')],             loadComponent: () => import('./pages/sances/financeiro/pmr/pmr').then(m => m.PmrComponent) },
      ...
      { path: 'receber',         canActivate: [permissaoGuard('receber')],         loadComponent: () => import('./pages/sances/financeiro/receber/receber').then(m => m.ReceberComponent) },
      { path: 'pagar',           canActivate: [permissaoGuard('pagar')],           loadComponent: () => import('./pages/sances/financeiro/pagar/pagar').then(m => m.PagarComponent) },
