...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'taxa_recebimento',            canActivate: [permissaoGuard('taxa_recebimento')],    loadComponent: () => import('./pages/sances/financeiro/taxa-recebimento/taxa-recebimento').then(m => m.TaxaRecebimentoComponent) },
      { path: 'taxa_pagamento',            canActivate: [permissaoGuard('taxa_pagamento')],    loadComponent: () => import('./pages/sances/financeiro/taxa-pagamento/taxa-pagamento').then(m => m.TaxaPagamentoComponent) },
