...
import { ReceberService } from '../../../../shared/services/receber.service';
  ...
  template: `
    <div class="page">
      ...
      <div class="page-header">
        <div>
          <h1 class="page-title">Análise <span>Contas a Receber</span></h1>
          <p class="page-sub">
              ...
              <div class="help-backdrop" (click)="fecharAjuda()">
                <div class="help-modal" (click)="$event.stopPropagation()">
                  <div class="help-header">
                    <div>
                      <div class="help-badge">📊 Dashboard Contas a Receber</div>
...
protected readonly nomeArquivoRecebimento = this.recebimentoColunasProvider.getNomeArquivoExport();
  ...
  protected readonly svc = inject(ReceberService);
  ...
  exportarTaxaPorCliente(): void {
    ...
    this.excelExport.exportar(dados, 'recebimento_por_cliente');
  }
}