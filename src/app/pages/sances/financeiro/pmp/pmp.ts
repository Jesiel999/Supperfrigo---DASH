...
import { PmpService } from '../../../../shared/services/pmp.service';
  ...
  template: `
    <div class="page">
      <div class="page-header">
        <div>
          <h1 class="page-title">Análise <span>Prazo Médio de Pagamento</span></h1>
          <p class="page-sub">
            Última atualização:
                      ...
                      <div class="help-header">
                          <div>
                              <div class="help-badge">
                                  📊 Dashboard Prazo Médio de Pagamento
                              </div>
...
export class PmpComponent implements OnInit {
  protected readonly svc = inject(PmpService);
